...
```java
CompletableFuture<PaymentAuthorization> authorizationsGetAsync(
...
```java
CompletableFuture<CapturedPayment> authorizationsCaptureAsync(
...
```java
CompletableFuture<PaymentAuthorization> authorizationsReauthorizeAsync(
...
```java
CompletableFuture<PaymentAuthorization> authorizationsVoidAsync(
...
```java
CompletableFuture<CapturedPayment> capturesGetAsync(
