...
| `AccountStatus` | [`PayPalWalletAccountVerificationStatus`](../../doc/models/pay-pal-wallet-account-verification-status.md) | Optional | The account status indicates whether the buyer has verified the financial details associated with their PayPal account.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255`, *Pattern*: `^[A-Z_]+$` | PayPalWalletAccountVerificationStatus getAccountStatus() | setAccountStatus(PayPalWalletAccountVerificationStatus accountStatus) |
