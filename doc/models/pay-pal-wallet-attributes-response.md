...
|  --- | --- | --- | --- | --- | --- |
| `Vault` | [`PayPalWalletVaultResponse`](../../doc/models/pay-pal-wallet-vault-response.md) | Optional | The details about a saved PayPal Wallet payment source. | PayPalWalletVaultResponse getVault() | setVault(PayPalWalletVaultResponse vault) |
