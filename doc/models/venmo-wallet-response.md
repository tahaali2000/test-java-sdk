...
| `UserName` | `String` | Optional | The Venmo user name chosen by the user, also know as a Venmo handle.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `50`, *Pattern*: `^[-a-zA-Z0-9_]*$` | String getUserName() | setUserName(String userName) |
