...
| `Card` | `Object` | Optional | The payment card information. | Object getCard() | setCard(Object card) |
...
| `AssuranceDetails` | `Object` | Optional | - | Object getAssuranceDetails() | setAssuranceDetails(Object assuranceDetails) |
