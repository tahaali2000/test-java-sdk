...
| `PaymentDescriptor` | `String` | Optional | P24 generated payment description.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `2000` | String getPaymentDescriptor() | setPaymentDescriptor(String paymentDescriptor) |
